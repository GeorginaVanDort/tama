...
public class WaterMonsterTest {
  ...
  public void WaterMonster_instantiatesCorrectly_true() {
    WaterMonster testWaterMonster = new WaterMonster("Squeaky", 1);
  ...
  public void WaterMonster_instantiatesWithName_String() {
    WaterMonster testWaterMonster = new WaterMonster("Squeaky", 1);
    assertEquals("Squeaky", testWaterMonster.getName());
  }
  ...
  public void equals_returnsTrueIfNameAndPersonIdAreSame_true() {
    WaterMonster testWaterMonster = new WaterMonster("Squeaky", 1);
    WaterMonster anotherWaterMonster = new WaterMonster("Squeaky", 1);
  ...
  @Test
    public void all_returnsAllInstancesOfWaterMonster_true() {
      WaterMonster firstWaterMonster = new WaterMonster("Squeaky", 1);
  ...
  public void save_savesPersonIdIntoDB_true() {
    ...
    testPerson.save();
    WaterMonster testWaterMonster = new WaterMonster("Squeaky", testPerson.getId());
    testWaterMonster.save();
  ...
  public void timer_executesDepleteLevelsMethod() {
    WaterMonster testWaterMonster = new WaterMonster("Squeaky", 1);
    int firstPlayLevel = testWaterMonster.getPlayLevel();//snapshot
    testWaterMonster.startTimer();
    try {
      Thread.sleep(6000);//pause for 6 seconds
    } catch (InterruptedException exception){}
    // pausing a JUnit test sometimes results in an exception
    int secondPlayLevel = testWaterMonster.getPlayLevel();//second snapshot
