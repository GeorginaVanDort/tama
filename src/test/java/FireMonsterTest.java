...
public class FireMonsterTest {
  ...
  public void monster_instantiatesCorrectly_true() {
    FireMonster testFireMonster = new FireMonster("Squeaky", 1);
  ...
  public void FireMonster_instantiatesWithName_String() {
    FireMonster testFireMonster = new FireMonster("Squeaky", 1);
    assertEquals("Squeaky", testFireMonster.getName());
  }
  ...
  public void equals_returnsTrueIfNameAndPersonIdAreSame_true() {
    FireMonster testFireMonster = new FireMonster("Squeaky", 1);
    FireMonster anotherFireMonster = new FireMonster("Squeaky", 1);
  ...
  @Test
    public void all_returnsAllInstancesOfFireMonster_true() {
      FireMonster firstFireMonster = new FireMonster("Squeaky", 1);
  ...
  public void save_savesPersonIdIntoDB_true() {
    ...
    testPerson.save();
    FireMonster testFireMonster = new FireMonster("Squeaky", testPerson.getId());
    testFireMonster.save();
  ...
  public void timer_executesDepleteLevelsMethod() {
    FireMonster testFireMonster = new FireMonster("Squeaky", 1);
    int firstPlayLevel = testFireMonster.getPlayLevel();//snapshot
    ...
    int secondPlayLevel = testFireMonster.getPlayLevel();//second snapshot
